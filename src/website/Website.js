...
class Website extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            about: {
                oneline: 'Mission-driven full stack developer with a passion for thoughtful UI design, collaboration, and teaching.',
                long: `I’ve always sought out opportunities and challenges that are meaningful to me. Although my professional path has taken many twists and turns — from touring and recording artist, to employee of the year at a non-profit, to dean's scholar at UPenn, to small business owner and entrepreneur — I've never stopped engaging my passion to help others and solve problems.
                ...
                currentFocus: ['Accessibility', 'React', 'Design System'],
            },
            projects: [
                {
                    "name": "DOST",
                ...
                <div className="col-xs-12 col-sm-12 col-md-10 right-side">
                    ...
                    <div className="about-page page-section" id="about">
                        ...
                        <div className="about-container">
                            <div className="short-bio">{this.state.about.oneline}</div>
                            <div className="about-myself">
                                <p>{this.state.about.long}</p>
                            </div>
                            <div className="current-focus">
                                <strong>Current Focus:</strong>
                                {this.state.about.currentFocus.map((focus, i) => <span key={i}>{focus}</span>)}
                            </div>
                        </div>
                    </div>
